...
{
    internal class StudentListByClassDialog : DialogBase
    {
        private IClassRepository _classRepo;
        private IStudentRepository _studentRepo;

        public StudentListByClassDialog(IClassRepository classRepo, IStudentRepository studentRepo)
        {
        ...
        {
            //prompting to choose a class
            string chosenClass = AnsiConsole.Prompt(new SelectionPrompt<string>()
                .Title("Choose a [green]class[/]?")
            ...
            // querying students
            var studentList = _studentRepo.GetStudentsByClass(
